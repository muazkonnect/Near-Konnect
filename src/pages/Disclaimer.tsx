...
const Disclaimer = () => (
  <LegalLayout
    title="Disclaimer"
    subtitle="Important context about the information and services available on Near Konnect."
  >
    <LegalSection index={1} title="General Information">
      <p>
        The information provided on Near Konnect is for general informational purposes only. All information on the
    ...
    <LegalSection index={2} title="External Links">
      <p>
        ...
        Near Konnect does not warrant or make any representations regarding the quality, accuracy, or availability of
    ...
    <LegalSection index={3} title="Professional Disclaimer">
      <p>
        Near Konnect does not provide professional advice. The platform serves solely as a communication bridge
        between customers and service workers. Any reliance you place on such information is strictly at your own
        risk.
      </p>
      <p className="mt-3">
        Contact information of workers is only shared with clients they have explicitly approved. Near Konnect does
    ...
    <LegalSection index={4} title="Limitation of Liability">
      <p>
        In no event shall Near Konnect be liable for any loss or damage including, without limitation, indirect or
