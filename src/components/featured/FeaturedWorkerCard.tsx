...
/**
 * Premium featured wrapper around WorkerCard.
 * Adds a subtle amber ring and a "Featured" pill, no aggressive ad styling.
 */
export default function FeaturedWorkerCard({ worker, onClick }: Props) {
  return (
    <div className="relative">
      ...
      <div className="rounded-2xl ring-2 ring-amber-400/40 shadow-[0_8px_24px_-8px_hsl(45_93%_47%/0.35)]">
        <WorkerCard worker={worker} onClick={onClick} />
      </div>
    </div>
  );
}
