...
import { Heart, ArrowRight, AlertTriangle, Users } from "lucide-react";
        ...
        <div className="relative flex flex-col sm:flex-row items-start sm:items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground">
              Connect privately with verified donors near you
              {activeRequests > 0 && (
                <> · <span className="font-semibold text-orange-500">{activeRequests}</span> active request{activeRequests !== 1 ? "s" : ""}</>
              )}
            </p>
          </div>
      ...
      <div className="relative grid md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <p className="text-muted-foreground mb-6 max-w-md leading-relaxed">
            Privately connect with willing blood donors in your area. Donors stay anonymous until they choose to share contact details.
          </p>
        ...
        <div className="grid grid-cols-1 gap-4">
          <div className="bg-white/80 dark:bg-card/80 backdrop-blur-sm rounded-2xl border border-orange-100 dark:border-orange-900/30 p-5 text-center">
            ...
            <p className="text-3xl font-extrabold text-orange-500">{activeRequests}</p>
            <p className="text-xs text-muted-foreground mt-1">Active Requests</p>
          </div>
          <div className="bg-white/80 dark:bg-card/80 backdrop-blur-sm rounded-2xl border border-green-100 dark:border-green-900/30 p-4 text-center">
            <p className="text-sm text-muted-foreground">
