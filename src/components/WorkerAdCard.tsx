      ...
      >
        ...
        >
          ...
          <div className="relative min-w-0 flex-1 flex-col p-2.5 pt-7 pr-3 flex items-start justify-center gap-0">
            ...
            <div className="grid grid-cols-2 gap-1.5 mx-px my-[5px]">
            ...
            <div className="mt-0.5 grid grid-cols-[1fr_auto] gap-1.5 my-px text-center px-[21px] mx-[62px]" onClick={(e) => e.stopPropagation()}>
              ...
              {(() => {
                ...
                const ctaClass = `group/btn inline-flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-r ${t.grad} text-black shadow-lg shadow-lime-500/15`;
